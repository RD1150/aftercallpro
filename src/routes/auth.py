...
def _do_register(data):
    ...
    # The dedicated Twilio number is provisioned after payment clears — see
    # handle_checkout_completed in payments.py. Provisioning is deliberately
    # NOT done here, so unpaid/abandoned signups never trigger a number
    # purchase.
