    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] text-white py-24 pb-20 text-center">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <p className="text-xl md:text-[22px] mb-16 text-[#e0e0e0] max-w-[800px] mx-auto leading-relaxed text-center">
        ...
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-15">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-[#1a1a2e]">Multi-Location Support</h3>
              <p className="text-[#666] leading-relaxed">Custom greetings and playbooks for each location. Perfect for businesses with multiple offices.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-[#00d4ff] to-[#0099cc] rounded-full flex items-center justify-center mx-auto mb-5 text-4xl">
                🎯
